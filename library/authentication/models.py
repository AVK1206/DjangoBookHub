...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    @staticmethod
    def create(email, password, first_name=None, middle_name=None, last_name=None, role=1, is_active=True):
        """
    ...
    @staticmethod
    def get_by_password(hashed_password, password):
        """
        Args:
            hashed_password: hashed by SHA256
            password: str

        Returns: True if passwords matched
        """
